 ...
 */
package anbientget.tools;

import anbientget.AnimeDatabase;
...
public class Tools {
    ...
    private static ImageIcon icone = new ImageIcon(Tools.class.getClassLoader().getResource("anbientget/icons/icon.png"));
